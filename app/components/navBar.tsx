...
export default function Nav() {
  ...
  return (
    <nav className="fixed no_w:h-30 no_w:flex-col xsm:flex-row xsm:h-auto top-0 left-0 w-full flex justify-between gap-2 p-2 bg-slate-800">
      ...
      {isLoggedIn ? (
        ...
        <div className="flex gap-2">
          <Link
            href="/signup"
            className="bg-lime-500 no_w:w-full rounded-md p-2"
          >
            Signup
          </Link>
          <Link
